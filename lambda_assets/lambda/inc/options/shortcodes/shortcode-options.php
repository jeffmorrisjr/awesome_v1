            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc'    => __('Number of services to show', 'lambda-admin-td'),
                        'id'      => 'count',
                        'type'    => 'slider',
                        'default' => 3,
                        'admin_label' => true,
            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc'    => __('Number of Testimonials to display', 'lambda-admin-td'),
                        'id'      => 'count',
                        'type'    => 'slider',
                        'admin_label' => true,
                        'default' => 3,
            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc'    => __('Number of members to display', 'lambda-admin-td'),
                        'id'      => 'count',
                        'type'    => 'slider',
                        'admin_label' => true,
                        'default' => 3,
            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc'    => __('Number of posts to display per row', 'lambda-admin-td'),
                        'id'      => 'columns',
                        'type'    => 'select',
                        'options' => array(
                            2 => __('Two columns', 'lambda-admin-td'),
                    ...
                    array(
                        ...
                        'default' => 'small',
                        'options' => array(
                            'small' => __('Simple post with title & excerpt on the side', 'lambda-admin-td'),
    ...
    'map' => array(
        ...
        'sections'      => array(
            ...
            array(
                ...
                'fields' => array(
                    array(
                        'name'      => __('Show Marker', 'lambda-admin-td'),
                        'id'        => 'marker',
                        'type'      => 'select',
                        'default'   =>  'show',
                        'options' => array(
                    ...
                    array(
                        'name'    => __('Marker Label', 'lambda-admin-td'),
                        'desc'    => __('Label to show above the marker', 'lambda-admin-td'),
                        'id'      => 'label',
                        'default' =>  '',
                        'type'    => 'text',
                    ),
                    array(
                        'name'    => __('Marker Address', 'lambda-admin-td'),
                        'desc'    => __('Address to show marker', 'lambda-admin-td'),
                        'id'      => 'address',
                        'default' =>  '',
                        'type'    => 'text',
                    ),
                    array(
                        'name'    => __('Marker Latitude', 'lambda-admin-td'),
                        'desc'    => __('Latitude of marker (if you dont want to use address)', 'lambda-admin-td'),
                        'id'      => 'lat',
                        'default' =>  '',
                        'type'    => 'text',
                    ),
                    array(
                        'name'    => __('Marker Longitude', 'lambda-admin-td'),
                        'desc'    => __('Longitude of marker (if you dont want to use address)', 'lambda-admin-td'),
                        'id'      => 'lng',
                        'default' =>  '',
                        'type'    => 'text',
                    ),
            ...
            array(
                ...
                'fields' => array(
                    array(
                        'name'      => __('Map Section Height', 'lambda-admin-td'),
                        'id'        => 'height',
                        'type'      => 'slider',
                        'default' => 500,
                        'attr'    => array(
            ...
            array(
                ...
                'fields'  => array(
                    ...
                    array(
                        ...
                        'desc'      => __('Height of divider on mobile displays (>1200px).', 'lambda-admin-td'),
                        'id'        => 'lg_height',
                        'type'      => 'slider',
                        'default'   => 24,
                        'attr'      => array(
