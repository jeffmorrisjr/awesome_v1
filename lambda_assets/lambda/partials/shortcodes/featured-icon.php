<div class="box <?php echo esc_attr(implode(' ', $classes)); ?>" data-os-animation="<?php echo esc_attr($scroll_animation); ?>" data-os-animation-delay="<?php echo esc_attr($scroll_animation_delay); ?>s">
    ...
    <?php if( !empty( $link ) ) : ?>
        <a class="box-inner <?php echo esc_attr(implode( ' ', $link_classes )); ?> <?php echo esc_attr(implode( ' ', $overlay_classes )); ?>" href="<?php echo esc_url($link); ?>" <?php echo $background_colour; ?>>
    <?php else : ?>
