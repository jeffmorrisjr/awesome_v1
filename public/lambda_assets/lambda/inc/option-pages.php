...
if (isset($oxy_theme)) {
    ...
    $oxy_theme->register_option_page(array(
        ...
        'sections'   => array(
            'blog-section' => array(
                'title'   => __('General Blog Options', 'lambda-admin-td'),
            ...
            'blog-single-section' => array(
                ...
                'fields' => array(
                    ...
                    array(
                        'name'    => __('Post Media Position', 'lambda-admin-td'),
                        'desc'    => __('Choose to show post image/video/audio media above or below post title.', 'lambda-admin-td'),
    ...
    $oxy_theme->register_option_page(array(
        ...
        'sections'   => array(
            'permalinks-section' => array(
                ...
                'header'  => __('Some of the custom single pages (Portfolios, Services, Staff ) can be configured to use their own specoal url.  This helps with SEO.  Set your permalinks here, save and then navigate to one of the items and you will see the url in the format below.', 'lambda-admin-td'),
                'fields' => array(
                    array(
    ...
    $oxy_theme->register_option_page(array(
        ...
        'sections'   => array(
            'css-section' => array(
                ...
                'header'  => __('Here you can modify the themes advanced CSS options', 'lambda-admin-td'),
                'fields' => array(
                    array(
            ...
            'favicon-section' => array(
                'title'   => __('Site Fav Icon', 'lambda-admin-td'),
                'header'  => __('The site Fav Icon is the icon that appears in the top corner of the browser tab, it is also used when saving bookmarks.  Upload your own custom Fav Icon here, recommended resolutions are 16x16 or 32x32.', 'lambda-admin-td'),
                'fields' => array(
                    array(
                      'name' => __('Fav Icon', 'lambda-admin-td'),
                      'id'   => 'favicon',
                      'type' => 'upload',
                      'store' => 'url',
                      'desc' => __('Upload a Fav Icon for your site here', 'lambda-admin-td'),
                      'default' => OXY_THEME_URI . 'assets/images/favicons/favicon.ico',
                    ),
                )
            ),
            'apple-section' => array(
                'title'   => __('Apple Icons', 'lambda-admin-td'),
                'header'  => __('If someone saves a bookmark to their desktop on an Apple device this is the icon that will be used.  Here you can upload the icon you would like to be used on the various Apple devices.', 'lambda-admin-td'),
                'fields' => array(
                    array(
                        'name' => __('iPhone Icon (57x57)', 'lambda-admin-td'),
                        'id'   => 'iphone_icon',
                        'type' => 'upload',
                        'store' => 'url',
                        'desc' => __('Upload an icon to be used by iPhone as a bookmark (57 x 57 pixels)', 'lambda-admin-td'),
                        'default' => OXY_THEME_URI . 'assets/images/favicons/apple-touch-icon-precomposed.png',
                    ),
                    array(
                      'name' => __('iPhone Retina Icon (114x114)', 'lambda-admin-td'),
                      'id'   => 'iphone_retina_icon',
                      'type' => 'upload',
                      'store' => 'url',
                      'desc' => __('Upload an icon to be used by iPhone Retina as a bookmark (114 x 114 pixels)', 'lambda-admin-td'),
                      'default' => OXY_THEME_URI . 'assets/images/favicons/apple-touch-icon-114x114-precomposed.png',
                    ),
                    array(
                      'name' => __('iPad Icon (72x72)', 'lambda-admin-td'),
                      'id'   => 'ipad_icon',
                      'type' => 'upload',
                      'store' => 'url',
                      'desc' => __('Upload an icon to be used by iPad as a bookmark (72 x 72 pixels)', 'lambda-admin-td'),
                      'default' => OXY_THEME_URI . 'assets/images/favicons/apple-touch-icon-72x72-precomposed.png',
                    ),
                    array(
                      'name' => __('iPad Retina Icon (144x144)', 'lambda-admin-td'),
                      'id'   => 'ipad_icon_retina',
                      'type' => 'upload',
                      'store' => 'url',
                      'desc' => __('Upload an icon to be used by iPad Retina as a bookmark (144 x 144 pixels)', 'lambda-admin-td'),
