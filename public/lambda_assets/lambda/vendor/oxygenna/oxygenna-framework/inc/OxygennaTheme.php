...
class OxygennaTheme
{
    ...
    public function __construct($theme_args)
    {
        ...
        if (is_admin()) {
            load_theme_textdomain($this->theme_args['admin_text_domain'], get_template_directory() . '/inc/languages');
        } else {
            load_theme_textdomain($this->theme_args['text_domain'], get_template_directory() . '/languages');
        }
