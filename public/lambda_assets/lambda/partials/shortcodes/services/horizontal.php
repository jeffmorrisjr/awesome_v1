...
foreach( $services as $post ) :
    ...
    if( 'show' === $show_excerpts ) : ?>
        <p class="text-<?php echo esc_attr($align_excerpts); ?>">
    ...
    if( 'show' === $show_readmores ) : ?>
        <a href="<?php echo esc_url($link) ?>" class="more-link text-<?php echo esc_attr($align_excerpts); ?>" targets="<?php echo esc_attr($link_target); ?>">
